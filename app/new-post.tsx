...
const CreateNewPost = () => {
    ...
    const styles = useThemedStyles((t) => ({
        ...
        column: { flexDirection: "column", alignItems: "flex-start", justifyContent: "space-between", paddingVertical: 10 },
    }));
        ...
        tags: {
            custom: (value: string) => {
                ...
                const invalidTag = value
                    ...
                    .map((t) => t.trim())
                    .find((t) => t.length > 15);
                return invalidTag ? `Tag "${invalidTag}" is too long (max 15 chars)` : null;
            }
        },
        lang: { required: true },
    });
    ...
    const submitData = () => {
        ...
        // اگه ولیدیشن اوکی بود
        console.log("Form submitted ✅", { message, tags, lang });
        // اینجا مثلا می‌تونی API call بزنی
    }
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.containerScrollBox} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.messageBox}>
                    <ThemedText type='middleTitle' style={{ marginBottom: 10, fontWeight: 500 }}>
                        Description
                    </ThemedText>
                    ...
                    <TextInput
                        ...
                        multiline
                    />
                    <ThemedText type='subText' style={styles.charCount}>{`${message.length}/300 characters`}</ThemedText>
                    {errors.message && (
                ...
                <View style={styles.column}>
                    <View style={{ flex: 1 }}>
                        <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                            ...
                            <ThemedText type="subtitle" style={{ color: theme.text, fontWeight: 400 }}>
                                Post Visibility
                            </ThemedText>
                        </View>
                        <ThemedText type="subText" style={[styles.rowSubtitle, {}]}>
                    ...
                    />
                    {errors.lang && <ThemedText style={{ color: 'red' }}>{errors.lang}</ThemedText>}

                </View>


                <TouchableOpacity style={styles.readBtn} onPress={submitData}>
